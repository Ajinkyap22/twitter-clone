  ...
  return (
    <div className="h-100vh sticky-top d-flex flex-column align-items-end justify-content-between border-end pe-sm-3 mt-1">
      <ListGroup className="d-flex align-items-start pe-sm-1 pe-xl-5">
        {/* twitter logo */}
        <Link to="/home">
          <ListGroupItem className="cursor-pointer border-0 d-flex justify-content-start w-100 p-0 bg-body-primary">
        ...
        <Link to="/home">
          <ListGroupItem
            className="cursor-pointer border-0 d-flex my-1 py-2_5 align-items-center link-hover text-decoration-none"
            active={false}
          >
            {currentPage === "home" ? (
        ...
        {/* tweet */}
        <ListGroupItem className="border-0 d-flex my-1 py-2_5 mt-1 px-0 align-self-stretch d-none d-xl-inline-flex">
          <Button
        ...
        <ListGroupItem className="border-0 d-flex my-1 py-2_5 mt-1 px-0 align-self-center d-block d-xl-none">
          <Button
