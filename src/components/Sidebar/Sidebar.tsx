...
const Sidebar = (props: Props) => {
  return (
    <>
      <ListGroup className="d-flex align-items-start pe-6">
        ...
        <ListGroupItem className="cursor-pointer border-0 d-flex my-1 py-2_5 align-items-center link-hover">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e w-5 h-5"
          >
            <g>
      ...
      {/* user details */}
      <ListGroup>
        <ListGroupItem className="d-flex border-0 align-items-center cursor-pointer link-hover mb-2">
          {/* profile picture */}
          <div>
            <img src={Logo} alt="Logo" className="w-6 h-6 py-1" />
          </div>
          ...
          <div className="ms-4 me-4">
            <h6 className="mb-0">Damini Pandey</h6>
            <span className="text-muted">@Daminip078667</span>
          </div>
