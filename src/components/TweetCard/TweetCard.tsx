          ...
          <div className="d-flex justify-content-between p-1">
            ...
            <Link to={`/${username}/status/${tweet.id}`} className="text-dark">
              <div className="d-flex">
                <button
                  title="Reply"
                  className="border-0 bg-transparent blue-hover p-2 d-flex align-items-center justify-content-center text-muted cursor-pointer"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <div className="d-flex ">
              <button
                title="Retweet"
                className="border-0 bg-transparent retweet p-2 d-flex align-items-center justify-content-center text-muted cursor-pointer"
            ...
            <div className="d-flex ">
              <button
                title="Like"
                className={`border-0 bg-transparent like p-2 d-flex align-items-center justify-content-center text-muted cursor-pointer
               ${isLiked ? "liked" : ""}`}
